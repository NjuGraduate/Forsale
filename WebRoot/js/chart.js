window.onload = function(){  
	$.getJSON({
		url:"managerActionInfo/commentEveryMonth.do",
		success:getValue
	});
	$.getJSON({
		url:"managerActionInfo/recordEveryMonth.do",
		success:getRecord
	});
}
   //交易折线
					...
					strs = strs.split(";");
					 var multiData = {values:[
						 { value0:[
						   ...
						   //先定义数据线的名字，再绘制数据
						   LineChart.setKey(["2017"]);
						   LineChart.setData("canvas2",multiData,60,"red","#333",true,true);
						 }
